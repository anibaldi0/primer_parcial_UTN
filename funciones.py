...
# def mostrar_logros(jugadores_coincidentes: list) -> list:
#     jugador_encontrado = None
#     jugador_seleccionado = elegir_jugador(jugadores_coincidentes)
#     for jugador in jugador_seleccionado:
#         if jugador["nombre"] == jugador_seleccionado:
#             jugador_encontrado = jugador
#             break
#     if jugador_encontrado is not None:
#         print(jugador_encontrado["logros"])
#     else:
#         print("No se encontro jugador")
#         #print("\nLogros del jugador \033[92m{0}\033[0m:".format(jugador_seleccionado[indice]))
